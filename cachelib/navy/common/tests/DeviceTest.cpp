...
struct DeviceParamTest : public testing::TestWithParam<std::tuple<int, bool>> {
  DeviceParamTest()
      : qDepth_(std::get<0>(GetParam())),
        enableIoUring_(std::get<1>(GetParam())) {
    XLOGF(INFO, "DeviceParamTest: qDepth={}, enableIoUring={}", qDepth_,
          enableIoUring_);
  }
